...
router.post("/referrals/info", use("referralProgramInfo"));
router.post("/referrals/register", use("referralRegister"));
router.post("/referrals/verify", use("referralVerifyEmail"));
router.get("/referrals/verify", use("referralVerifyEmail"));
router.post("/referrals/login", use("referralLogin"));
router.post("/referrals/auth", use("referralAuth"));
router.post("/referrals/dashboard", use("referralDashboard"));
router.post("/referrals/withdraw", use("referralWithdraw"));
router.post("/referrals/logout", use("referralLogout"));
router.post("/manager/referrals", use("managerReferralDashboard"));
router.post("/manager/referrals/withdrawals/resolve", use("managerResolveReferralWithdrawal"));
...
router.post("/logoutManager", use("logoutManager"));
...
router.post("/cardBilling", use("fetchCardBilling"));
router.post("/cardBilling/setup", use("setupCardBilling"));
router.post("/cardBilling/cancel", use("cancelCardBilling"));
router.post("/cardBilling/verify", use("verifyPaystackCardBilling"));
router.get("/paystack/cardBilling/callback", use("paystackCardBillingCallback"));
router.post("/paystack/cardBilling/webhook", use("paystackCardBillingWebhook"));
router.post("/intasend/subscription-webhook", use("intasendSubscriptionWebhook"));
router.post("/managerBillPayments", use("managerBillPayments"));
router.post("/managerB2BPayments", use("managerB2BPayments"));
...
router.post("/managerDeleteB2BPayment", use("managerDeleteB2BPayment"));
...
router.post("/managerUpdateB2BPayment", use("managerUpdateB2BPayment"))
...
router.post("/managerBlogs", use("managerFetchBlogs"));
router.post("/managerAddBlog", use("managerAddBlog"));
router.post("/managerUpdateBlog", use("managerUpdateBlog"));
router.post("/managerDeleteBlog", use("managerDeleteBlog"));
router.post("/managerUploadBlogImage", use("managerUploadBlogImage"));
router.post("/publicBlogs", use("fetchPublicBlogs"));
router.post("/publicBlog", use("fetchPublicBlogBySlug"));
